    ...
    public void lounchEvents() {
        ...
        btnAxisY.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /* Con este metodo en java metemos una animacion dentro de otra
                animY.setAnimationListener(new Animation.AnimationListener() {
                    @Override
        ...
        btnScale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  ivScale.startAnimation(animScale);
                ...
                animatorSetScale.play(oaScaleX).with(oaScaleY);
        ...
        btnAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             ...
             //  ivAll.startAnimation(animAll);
                ...
                animatorSetAll.playTogether(oaAxisX, oaAxisY, oaAlpha);
